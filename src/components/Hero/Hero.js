            ...
            <section className={styles.heroContainer}>
                ...
                <div className={styles.contentWrapper}>
                    ...
                    <p className={styles.content}>
                        ...
                        elit. Nisi, distinctio voluptate voluptatem
                        exercitationem, temporibus amet adipisci libero aliquid
                        quasi qui incidunt asperiores cumque omnis quae facilis
                        natus eius ad id.
                    </p>
